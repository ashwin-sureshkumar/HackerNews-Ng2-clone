import { Component, Input, ViewChild, ComponentFactoryResolver, ViewContainerRef, Type, OnInit } from '@angular/core';
...
export class ItemComponent implements OnInit {
  ...
  loadComponent(item) {
    const componentFactory = this.componentFactoryResolver.resolveComponentFactory(this.getItemMapping(item.type));
